...
```
./configure --with-tarballs=$HOME/android-tools/xbmc-tarballs --host=aarch64-linux-android --with-sdk-path=$HOME/android-tools/android-sdk-linux --prefix=$HOME/android-tools/xbmc-depends --enable-debug=false --enable-optimizations
```

Or configure build for arm:
```
./configure --with-tarballs=$HOME/android-tools/xbmc-tarballs --host=arm-linux-androideabi --with-sdk-path=$HOME/android-tools/android-sdk-linux --prefix=$HOME/android-tools/xbmc-depends --enable-debug=false --enable-optimizations
```

Or configure build for x86:
```
./configure --with-tarballs=$HOME/android-tools/xbmc-tarballs --host=i686-linux-android --with-sdk-path=$HOME/android-tools/android-sdk-linux --prefix=$HOME/android-tools/xbmc-depends --enable-debug=false --enable-optimizations
```

Or configure build for x86_64:
```
./configure --with-tarballs=$HOME/android-tools/xbmc-tarballs --host=x86_64-linux-android --with-sdk-path=$HOME/android-tools/android-sdk-linux --prefix=$HOME/android-tools/xbmc-depends --enable-debug=false --enable-optimizations
```
...
```
mkdir $HOME/Projects/dakaitv/DKMC/build.arm64
make -C tools/depends/target/cmakebuildsys BUILD_DIR=$HOME/Projects/dakaitv/DKMC/build.arm64
```
mkdir $HOME/Projects/dakaitv/DKMC/build.arm32
make -C tools/depends/target/cmakebuildsys BUILD_DIR=$HOME/Projects/dakaitv/DKMC/build.arm32
